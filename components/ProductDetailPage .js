  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="relative h-80 w-full rounded-lg overflow-hidden flex justify-center items-center bg-gray-50">
          <img
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-xl md:text-2xl text-blue-600 font-bold mb-4">
          ...
          <h2 className="text-lg md:text-xl font-semibold mb-2">Mô tả sản phẩm</h2>
          <p className="text-gray-700 mb-6 whitespace-pre-line text-left">{product.description}</p>
      ...
      {showOrderModal && (
        <div className="fixed inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-4 md:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto mx-auto">
            {!orderSuccess ? (
              <>
